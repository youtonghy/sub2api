...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.POST("/account-hourly-failures", h.Admin.Ops.GetAccountHourlyFailures)
		...
		ops.GET("/account-ttft", h.Admin.Ops.GetAccountTTFTStats)
	}
}
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/accounts-ranking", h.Admin.Dashboard.GetAccountUsageRanking)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/model-options", h.Admin.Account.GetModelOptions)
		accounts.GET("/model-verification/history", h.Admin.Account.GetModelVerificationHistory)
		accounts.GET("/model-verification/jobs/:job_id", h.Admin.Account.GetModelVerificationJob)
		accounts.POST("/model-verification", h.Admin.Account.VerifyModels)
