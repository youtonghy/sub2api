<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.model" class="w-52" :options="mOpts" searchable :search-placeholder="t('admin.accounts.searchModels')" @update:model-value="updateModel" @change="$emit('change')" />
...
const props = defineProps<{ searchQuery: string; filters: Record<string, any>; groups?: AdminGroup[]; models?: string[] }>()
