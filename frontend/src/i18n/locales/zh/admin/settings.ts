export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        enabled: '启用全局自动探测',
        enabledHint: '开启后按设定周期运行；关闭后停止所有定时探测，手动探测不受影响。',
        allAccounts: '自动探测全部账号',
        allAccountsHint: '开启后探测全部活跃 API Key 账号，无需逐账号启用；账号级“同步上游声明倍率”仍单独控制是否改写账号倍率。',
      ...
      openaiExperimentalScheduler: {
        ...
        lowRatePriorityDescription: '开启后仍先比较账号优先级；同等优先级内严格按已探测计费倍率从低到高尝试，低倍率不可用时才回退到更高倍率。该严格顺序优先于实验调度评分。',
