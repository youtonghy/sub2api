export default {
    ops: {
      ...
      providerMonitor: {
        title: 'Provider 实时监控',
        description: '实时查看账号调用、并发负载、冷却与故障状态。',
        refreshRate: '每 2 秒刷新',
        activeProviders: '正在调用',
        aggregateLoad: '整体负载',
        coolingProviders: '冷却中',
        attentionProviders: '需要关注',
        provider: 'Provider',
        liveLoad: '实时负载',
        state: '当前状态',
        calls: '调用',
        unlimited: '不限',
        queued: '{count} 个请求排队',
        empty: '当前筛选条件下暂无 Provider',
        loadFailed: '加载 Provider 实时状态失败',
        accountError: '账号仍处于错误状态',
        strictFallbackCooldown: '严格优先级故障回退冷却',
        overloadedDetail: '上游过载，暂时停止调度',
        rateLimitedDetail: '上游限流，等待恢复',
        saturatedDetail: '负载已接近或达到容量上限',
        servingDetail: '正在处理用户请求',
        cooldownDetail: '等待冷却窗口结束',
        readyDetail: '可接收新的请求',
        states: {
          error: '持续报错',
          cooling: '冷却中',
