export default {
    settings: {
      ...
      upstreamBillingProbe: {
        ...
        enabledHint: 'When enabled, scheduled detection runs at the configured interval. Disabling stops all scheduled detection; manual detection remains available.',
        allAccounts: 'Automatically detect all accounts',
        allAccountsHint: 'Detect every active API key account without per-account opt-in. The account-level rate sync switch still controls whether the stored account rate is changed.',
      ...
      gatewayForwarding: {
        ...
        rewriteParallelToolCalls: 'Parallel Tool Calls Compatibility',
        rewriteParallelToolCallsHint: 'Rewrite parallel_tool_calls=true to false in OpenAI Responses requests for upstreams that require serial tool calls.',
      ...
      openaiExperimentalScheduler: {
        ...
        lowRatePriorityDescription: 'Account priority remains the primary order. Within the same priority, detected billing rates are tried strictly from low to high, falling back to a higher rate only when lower-rate accounts are unavailable. This strict order takes precedence over experimental scheduler scoring.',
