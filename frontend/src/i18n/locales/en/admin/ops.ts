export default {
    ops: {
      ...
      providerMonitor: {
        title: 'Provider Live Monitor',
        description: 'Live account traffic, concurrency load, cooldowns, and fault state.',
        refreshRate: 'Refreshes every 2s',
        activeProviders: 'In use',
        aggregateLoad: 'Aggregate load',
        coolingProviders: 'Cooling down',
        attentionProviders: 'Needs attention',
        provider: 'Provider',
        liveLoad: 'Live load',
        state: 'Current state',
        calls: 'calls',
        unlimited: 'unlimited',
        queued: '{count} requests queued',
        empty: 'No providers match the current filters',
        loadFailed: 'Failed to load live provider state',
        accountError: 'Account remains in an error state',
        strictFallbackCooldown: 'Strict-priority failover cooldown',
        overloadedDetail: 'Upstream overloaded; scheduling is paused',
        rateLimitedDetail: 'Upstream rate limited; waiting for recovery',
        saturatedDetail: 'Load is near or at capacity',
        servingDetail: 'Currently serving user requests',
        cooldownDetail: 'Waiting for the cooldown window to end',
        readyDetail: 'Ready to accept new requests',
        states: {
          error: 'Still failing',
          cooling: 'Cooling down',
          overloaded: 'Overloaded',
          rate_limited: 'Rate limited',
          saturated: 'Load alert',
          active: 'In use',
          idle: 'Idle'
        }
      },
