export default {
    accounts: {
      ...
      modelTest: {
        ...
        summary: '{accounts} accounts, {models} model tests',
        hint: 'Click a model to test it. Green means success and red means failure.',
        verificationHint: 'Choose one GPT-5.6 model, then one account or all accounts. Each model keeps its previous report.', previousReports: 'Previous reports', modelsReported: 'models reported',
        testAll: 'Test all',
        ...
        verificationLevel: 'Verification level', levelLow: 'Quick (19 requests)', levelMedium: 'Standard (49 requests)', levelHigh: 'Strict (158 requests)', verifyAuthenticity: 'Verify authenticity', verifying: 'Verifying...', verificationReport: 'Model authenticity report', accountsChecked: 'accounts checked', probesMatched: 'valid checks', viewEvidence: 'View evidence', verificationFailed: 'Verification failed', claimMismatch: 'claimed model mismatch',
        verdicts: {
          juice_pass_fingerprint_strong: 'Juice passed; behavioral fingerprint strongly matched',
          juice_pass_fingerprint_unclear: 'Juice passed; behavioral fingerprint unclear',
          juice_mismatch_fingerprint_strong: 'Deterministic mismatch; behavioral fingerprint strongly matched',
          juice_mismatch_fingerprint_unclear: 'Deterministic mismatch; behavioral fingerprint unclear',
          juice_insufficient_fingerprint_strong: 'Juice insufficient; behavioral fingerprint strongly matched',
          juice_insufficient_fingerprint_unclear: 'Juice and behavioral fingerprint both insufficient',
          possible_non_gpt: 'Possibly not GPT',
          strong_match: 'Behavioral fingerprint strongly matched',
          evidence_unclear: 'Behavioral fingerprint unclear',
        },
      },
      failureHeatmap: {
